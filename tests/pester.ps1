...
Remove-Module MSGraphPermissions -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\MSGraphPermissions\MSGraphPermissions.psd1"
Import-Module "$PSScriptRoot\..\MSGraphPermissions\MSGraphPermissions.psm1" -Force
